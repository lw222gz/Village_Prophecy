...
*/
PlayerStatsManager::PlayerStatsManager(PlayerSkillManager *_skillManager, Texture *APTexture, Texture *consumedAPTexture) 
...
int PlayerStatsManager::getPlayerAttackDamage(){
	//if the player has no action points the player suffers from fatigue
	if (actionPoints <= 0){
		return playerAttackDamage * 0.2;
	}
...
void PlayerStatsManager::PlayerLevelUp(){
	switch (currentLevel)
	{
		...
		case LEVEL_5:
			...
			ExperiencePointsToLevel = LEVEL_7;
		...
		case LEVEL_6:
			...
			ExperiencePointsToLevel = LEVEL_8;
		...
		case LEVEL_8:
			...
			ExperiencePointsToLevel = LEVEL_10;
		...
		case LEVEL_9:
			...
			ExperiencePointsToLevel = LEVEL_11;
