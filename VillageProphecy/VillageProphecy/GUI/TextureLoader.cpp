...
TextureLoader::TextureLoader()
{
	...
	if (!HealStationTexture.loadFromFile("Textures/HealingStation.png")){
		throw "TEXTURE LOAD ERROR: Healing station texture could not load correctly.";
	}
...
/*
* @RETURNS
* returns pointer to texture for the healing station
*/
Texture *TextureLoader::getHealStationTexture(){
	return &HealStationTexture;
}
