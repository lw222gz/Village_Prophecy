...
#include "../Path.h"
#include "../../GameObjects/GameObject_Tree.h"
...
void SurvivalGameArea::generateGameArea(){
	...
	//spawns 5-10 trees as intializer. 2 trees are required to build a campfire. Rest are to
	//help the player heal in the beginning.
	SpawnTrees(rand() % (maxAmountOfTrees - 5 + 1) + 5);
